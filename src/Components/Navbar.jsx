        ...
        sections: [
          {
            ...
            name: 'Eyes',
            items: [
              { name: 'Brow Liner', href: '#' },
              { name: 'Brow Mascara', href: '#' },
              { name: 'Brow Pencil', href: '#' },
              { name: 'Eyeliner Pencil', href: '#' },
              { name: 'Eyeshadow Palette', href: '#' },
              { name: 'Liner Liquid', href: '#' },
              { name: 'Liner Mechanic', href: '#' },
              { name: 'Liner Pencil', href: '#' },
              { name: 'Mascara', href: '#' },
            ],
          },
          {
            ...
            name: 'Face',
            items: [
              { name: 'Cheek Tint', href: '#' },
              { name: 'Concealer Liquid', href: '#' },
              { name: 'Dual Powder Foundation', href: '#' },
              { name: 'Foundation Cream', href: '#' },
              { name: 'Foundation Cream To Powder', href: '#' },
              { name: 'Foundation Liquid', href: '#' },
              { name: 'Pressed Powder', href: '#' },
            ],
          },
          {
            id: 'brands',
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {navigation.pages.map((page) => (
                    <div key={page.name} className="flow-root">
                      <a href={page.href} className="-m-2 block p-2 font-medium text-gray-900 hover:text-pink-600">
                        {page.name}
                      </a>
                    </div>
                  ))}
              ...
              <div className="ml-4 flex lg:ml-0">
                <button onClick={() => navigate('/')} >
                  ...
                  <img
                    ...
                    src="https://1000logos.net/wp-content/uploads/2021/05/Avon-logo.png"
                    alt=""
                  />
                </button>
              </div>
                                ...
                                <div className="mx-auto max-w-7xl px-8 z-100 relative overflow-hidden">
                                  <div className="gap-x-8 gap-y-10 py-1">
                                    ...
                                    <div className="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-base">
                                      {category.sections.map((section) => (
                                        <div key={section.name}>
                                          <p id={`${section.name}-heading`} className="font-medium text-pink-700">
                                            {section.name}
                                          </p>
                                          <ul
                                            role="list"
                  ...
                  <div className="hidden lg:ml-8 lg:flex">
                    <a href="#" className="flex items-center text-gray-700 hover:text-gray-800">
                      <img
                        ...
                        className="block h-auto w-5 flex-shrink-0"
                      />
                      <span className="ml-3 block text-sm font-medium">USER</span>
                      <span className="sr-only">, change currency</span>
                    </a>
                  </div>
